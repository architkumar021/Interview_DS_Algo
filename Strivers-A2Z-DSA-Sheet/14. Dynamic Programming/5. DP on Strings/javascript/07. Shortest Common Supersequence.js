/*
=============================================================================
  QUESTION: 1092. Shortest Common Supersequence (LeetCode)
=============================================================================

  Shortest string containing both s1 and s2 as subsequences.
  Build LCS table, then backtrack: add common chars once, non-common from both.

  Example: "abac", "cab" → "cabac"

=============================================================================
  APPROACH: LCS Tabulation + Backtrack — O(N×M) Time, O(N×M) Space
=============================================================================
*/
