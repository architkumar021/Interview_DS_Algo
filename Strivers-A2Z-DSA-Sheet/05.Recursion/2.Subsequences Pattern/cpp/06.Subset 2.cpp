...
=============================================================================
  ...
  Pick/Not-Pick + Skip Duplicates. SORT first, when excluding skip ALL copies.
  DRY RUN [1,2,2]: Inc 1→Inc 2→Inc 2→[1,2,2] | Exc 2→[1,2] | Exc all 2s→[1]
    Exc 1→Inc 2→Inc 2→[2,2] | Exc 2→[2] | Exc all 2s→[] → 6 unique ✓
