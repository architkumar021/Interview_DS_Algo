/*
=============================================================================
  QUESTION: Reverse Stack using Recursion (GFG)
  Two functions: insertAtBottom (insert at bottom) + reverseStack (pop, reverse, insert at bottom)
  DRY RUN [1,2,3]: pop 3→reverse([1,2])→pop 2→reverse([1])→pop 1→[]=push 1→[1]
    insert 2 at bottom→[2,1] → insert 3 at bottom→[3,2,1] ✓
  Time: O(N²), Space: O(N)
=============================================================================
QUESTION:
