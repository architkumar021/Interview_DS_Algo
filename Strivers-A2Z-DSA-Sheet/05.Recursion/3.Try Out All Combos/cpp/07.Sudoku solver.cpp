...
=============================================================================
  ...
  Try digits 1-9 for each empty cell. isValid: check row, col, 3×3 box.
  3×3 box formula: board[3*(row/3)+i/3][3*(col/3)+i%3] for i=0..8
  No digit works → return false → parent backtracks. No empty cell → solved!
