...
=============================================================================
  ...
  Try colors 1..M for each node. Check no neighbor has same color. Backtrack.
  DRY RUN triangle (0-1,1-2,0-2), M=3: node0→1, node1→1 CLASH→2, node2→1 CLASH→2 CLASH→3 ✓
