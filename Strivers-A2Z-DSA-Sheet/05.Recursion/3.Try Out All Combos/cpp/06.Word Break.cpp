...
=============================================================================
  ...
  Try every substring from index. If in dict → recurse on remaining.
  DRY RUN "leetcode": "l"→no "le"→no "lee"→no "leet"→YES→"code"→YES→true ✓
  DRY RUN "catsandog": "cat"→YES→"sand"→YES→"og"→FAIL | "cats"→YES→"and"→YES→"og"→FAIL → false ✓
  Time: O(2^N) brute, Space: O(N)
=============================================================================
